...
console.log('new Sum = ' + sum2(1, 2, 3, 4));
...
console.log('new obj ' , newObjectLit());
...
console.log('new SumAndProduct' , newSumAndProduct(3, 9));
...
let message2 = name => `Hello ${name} from new function`;
